                                                       ...
                                                       const FString& InEntryWidgetClassName)
{
	...
	CommonRichText_DisableReason->SetText(InDataObject->IsDataCurrentEditable() ? FText::GetEmpty() : InDataObject->GetDisabledRichText());
}
...
void UWidget_OptionsDetailsView::ClearDetailsViewInfo()
{
	...
	CommonRichText_DisableReason->SetText(FText::GetEmpty());
}
