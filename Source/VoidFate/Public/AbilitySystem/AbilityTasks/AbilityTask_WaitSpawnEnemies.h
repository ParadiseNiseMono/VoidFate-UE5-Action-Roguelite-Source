...
DECLARE_DYNAMIC_MULTICAST_DELEGATE_OneParam(FWaitSpawnEnemiesDelegate,const TArray<AVFEnemyCharacter*>&,SpawnedEnemies);

/**
 * 用來召喚敵人的Ability Task
 */
UCLASS()
class VOIDFATE_API UAbilityTask_WaitSpawnEnemies : public UAbilityTask
{
	GENERATED_BODY()
...
private:
	...
	TSoftClassPtr<AVFEnemyCharacter> CachedSoftEnemyClassToSpawn;
