...
#include "AsyncAction_PushSoftAction.generated.h"
 ...
 */
UCLASS()
class VOIDFATE_API UAsyncAction_PushSoftAction : public UBlueprintAsyncActionBase
{
	GENERATED_BODY()
...
public:
	...
	static UAsyncAction_PushSoftAction* PushSoftWidget(const UObject* WorldContextObject,
