 ...
 */
UCLASS(Abstract)
class VOIDFATE_API UListDataObject_Value : public UListDataObject_Base
{
	GENERATED_BODY()
...
public:
	...
	void SetDefaultValueFromString(const FString& InDefaultString) {DefaultStringValue = InDefaultString;}
